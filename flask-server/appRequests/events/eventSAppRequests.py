...
def setEvent():
    if request.method == "POST":
        ...
        if user_id is None or start_date is None or end_date is None or start_time is None or end_time is None or content_type is None \
        ...
        return queries.setEvents((user_id, start_date, end_date,start_time, end_time, content_type, discription, title, watch_platform),
        db.get_db())
